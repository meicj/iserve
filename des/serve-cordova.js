...
const cordova = new _express2.default.Router();
...
_iserve.event.bindServeStatic(argv => {
  if (getIsCordovaProject(argv.workingdir)) {
    ...
    cordova.use(_express2.default.static(argv.workingdir + CORDOVA_WWW_DIR, _iserve2.default.staticServeOptions));
  }
});
...
cordova.get(['/cordova.js', 'cordova_plugins.js', '/plugins/'], (req, res, next) => {
  ...
  const options = Object.assign({
    root: workingDir
  }, _iserve2.default.staticServeOptions);
